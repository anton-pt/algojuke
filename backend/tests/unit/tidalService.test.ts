...
describe("TidalService", () => {
  ...
  describe("error handling", () => {
    ...
    test("throws ApiUnavailableError on 503 status", async () => {
      ...
      await expect(tidalService.search("test")).rejects.toThrow(
        ApiUnavailableError,
      );
    });
  ...
  describe("batch optimization", () => {
        ...
        included: [
          ...
          },
          {
            ...
            attributes: {
              files: [
                {
                  href: "https://resources.tidal.com/images/art-999/640x640.jpg",
                  meta: { width: 640, height: 640 },
                },
              ],
            },
    ...
    test("extracts ISRCs from track results for batch fetching", async () => {
      ...
      expect(batchTracksCall![0]).toMatch(
