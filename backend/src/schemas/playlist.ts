...
export const PlaylistExportRequestSchema = z.object({
  name: z
    ...
    .max(150, "Playlist name must be 150 characters or less"),
  tracks: z
    .array(TrackForExportSchema)
    .min(1, "At least one track is required")
    .max(50, "Maximum 50 tracks per playlist"),
});
...
export type PlaylistExportResponse = z.infer<
  typeof PlaylistExportResponseSchema
>;
