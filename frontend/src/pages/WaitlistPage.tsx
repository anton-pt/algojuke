  ...
  return (
    <AuthLayout>
      <div style={{ textAlign: "center" }}>
        ...
        >
          <h3
            style={{ color: "#fff", margin: "0 0 0.5rem 0", fontSize: "1rem" }}
          >
        ...
        <p style={{ marginTop: "1.5rem" }}>
          In the meantime, make sure you have a Tidal subscription ready –
          you'll need it to use AlgoJuke when you get access.
        </p>
