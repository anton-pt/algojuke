...
describe("ResultsList Organization", () => {
  describe("Section Headings", () => {
    ...
    test("shows album count in Albums heading", () => {
      ...
      expect(
        screen.getByRole("heading", { name: /albums \(150\)/i }),
      ).toBeInTheDocument();
    });
    ...
    test("shows track count in Tracks heading", () => {
      ...
      expect(
        screen.getByRole("heading", { name: /tracks \(1200\)/i }),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("Conditional Rendering", () => {
    test("shows only albums section when no tracks", () => {
      const albumsOnly = {
        ...mockResults,
        tracks: [],
        total: { ...mockResults.total, tracks: 0 },
      };
    ...
    test("shows only tracks section when no albums", () => {
      const tracksOnly = {
        ...mockResults,
        albums: [],
        total: { ...mockResults.total, albums: 0 },
      };
  ...
  describe("Results Summary", () => {
    test("displays total count summary", () => {
      ...
      expect(
        screen.getByText(/found 150 albums and 1200 tracks/i),
      ).toBeInTheDocument();
    });
